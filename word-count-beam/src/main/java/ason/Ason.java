...
public class Ason {
  ...
  private AsonSerializer serializer = AsonSerializer.get();
    ...
    if (Util.isNull(value)) {
      ...
      if (!(value instanceof AsonArray)) {
        throw new IllegalStateException(
            "Expected a .ason.AsonArray to convert to "
                + cls.getName()
                + ", found "
      ...
      if (!(value instanceof Ason)) {
        throw new IllegalStateException(
            "Expected a .ason.Ason to convert to "
                + cls.getName()
                + ", found "
                + value.getClass().getName()
                + ".");
  ...
  public <T> List<T> getList(@NotNull String key, Class<T> itemCls) {
    ...
    if (!(value instanceof AsonArray)) {
      throw new IllegalStateException(
          "Expected a .ason.AsonArray to convert to List, "
              + "found "
              + value.getClass().getName()
              + ".");
    }
